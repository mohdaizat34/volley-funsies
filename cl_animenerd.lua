...
function SimonScreen() 
	...
	simon_model:SetModel("models/player/eric_summer/male_06.mdl") 
	...
	simon_desc5:SetText("SPIKE/BLOCK\n1  2  (3)  4  5")      
	...
	simon_desc6:SetText("- Fast runner with 49 inches vertical jump!")     
	...
	function confirm_button:DoClick()
		...
		net.Start("simon_stats")  
		net.SendToServer()   
		net.Start("simon_selected")
		net.SendToServer()   
 	

 		--hook.Add("Think","Loop",function()     
		hook.Add( "PlayerButtonDown", "ability_spike", function(ply,button)     
			if ply:Team() == 3 then 
				--print("hey")

				--local ent =  ents.FindByClass( "prop_physics*" )
				--for k, v in pairs( ent ) do   
					--if ply:GetPos():Distance( v:GetPos() ) < 600 then 
				if  keybind_set == "a" then  
						if button == KEY_B then  
							if ply:GetPos():WithinAABox( pos1, pos2 ) then
								ply:LagCompensation(true)
								print("hellow world")
								net.Start("normal_spike")    
...
function MegScreen() 
	...
	simon_desc6:Dock(TOP)   
	simon_desc6:SetSize(100,100)              
	simon_desc6:SetText("- Able to toss to spiker super quick (For anime weebs, it will be quick toss like kageyama\n and hinata)")     
	simon_desc6:SetTextColor(Color(255, 255, 255))                
	simon_desc6:DockMargin( 0, 10 , 0, 0 )     
	simon_desc6:SetFont("tiny2")
	...
	function confirm_button:DoClick()
		...
		ability_label:Dock(TOP)  
		ability_label:SetSize(300,300)           
		ability_label:SetText("C - LOW TOSS \n V - MEDIUM TOSS\n B - FREAK TOSS!")     
		ability_label:SetTextColor(Color(255,255,255))                
		ability_label:DockMargin( 0, 300 , 0, 0 )      
		ability_label:SetFont("tiny2") 
		...
		net.Start("meg_stats") 
		net.SendToServer()  
		net.Start("meg_selected")  
		net.SendToServer()  

		-- MEG_ABILITY -------------------------
		hook.Add( "PlayerButtonDown", "ability_kageyama", function(ply,button)
			if ply:Team() == 4 then 
				if keybind_set == "a" then 
...
function ArmyScreen() 
	...
	simon_desc6:Dock(TOP)   
	simon_desc6:SetSize(100,100)              
	simon_desc6:SetText("- Able to block while pushing the ball downwards")     
	simon_desc6:SetTextColor(Color(255, 255, 255))                
	simon_desc6:DockMargin( 0, 10 , 0, 0 )     
	simon_desc6:SetFont("tiny2")
	...
	function confirm_button:DoClick()
		...
		ability_label:Dock(TOP)  
		ability_label:SetSize(300,300)          
		ability_label:SetText("C - WALL BLOCK \n V - RECEIVE\n L.Click - SPIKE")     
		ability_label:SetTextColor(Color(255,255,255))                
		ability_label:DockMargin( 0, 300 , 0, 0 )      
		ability_label:SetFont("tiny2") 
